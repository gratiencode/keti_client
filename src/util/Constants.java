...
public class Constants {
    ...
    public static final String DECHARGEMENT_VIEW = "dechargement.fxml";
    public static final String RETRAIT_VIEW = "retrait.fxml";
    public static final String VEHICULE_VIEW = "vehicule.fxml";
    public static final String CAISSE_VIEW = "caisse.fxml";
    ...
    public static final String DECHARGEMENT = "dechargement-ui";
